...
public class FuncionarioView {
	...
	ActionListener svActionListener = new ActionListener() {
		public void actionPerformed(ActionEvent e) {
			...
			f.consistirDados( txtNome.getText(), txtDataNasc.getText(), cidade,estado, txtRG.getText(), txtCPF.getText(), txtTelefone.getText(),txtNum.getText(), txtCep.getText(), txtComplemento.getText(), txtLogradouro.getText(),
					txtBairro.getText(), uf,cboxProfissao.getSelectedItem().toString().toUpperCase(),periodo);
